...
- 🔭 Atualmente estou trabalhando em projetos para **Portifólio**.
...
- 🚀 **Bacharelado em Ciência da Computação** - FIAP (Cursando)
- 🎓 **Análise e Desenvolvimento de Sistemas** - Universidade São Judas Tadeu
- 🛠️ **Técnico em Manutenção e Suporte em TI** - ETEC Adhemar Batista Heméritas
- 💻 **Técnico em Desenvolvimento de Sistemas** - ETEC Adhemar Batista Heméritas
